...
use app\admin\model\MerchantMoneyLog;
 ...
 * @icon fa fa-circle-o
 */
class Merchantcash extends Backend
{
    
    /**
     * Cash模型对象
     * @var \app\admin\model\Merchantcash
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\Merchantcash;
    ...
    public function check($ids){
        ...
        if ($this->request->isPost()) {
            ...
            if($bool && $params['status'] == 4){
                $user = \app\admin\model\Merchant::where('id',$row->merchant_id)->find(); //退还零钱
