...
class Expert extends Backend
{
    ...
    /**
     * Expert模型对象
     * @var \app\admin\model\question\Expert
     */
    protected $model = null;
    protected $modelChild = null;

    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\admin\model\question\Expert;
        $this->modelChild = new \app\admin\model\question\ExpertReply;
    ...
    public function audit($ids = null)
    {
        ...
        foreach($post['val'] as $k=>$v){
            Db::name('question_expert')->where(['id'=>$v['id']])->update(['status'=>'1']);
        }
        $this->success('成功');
    }
