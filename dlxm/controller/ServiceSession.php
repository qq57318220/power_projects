...
use app\admin\model\ServiceRecord;
...
class ServiceSession extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\ServiceSession;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            if(!empty($merchant)){
                $whereMerchant = ['service_session.merchant_id'=>$this->auth->merchant_id];
            }
            $total = $this->model
    ...
    public function detail($ids)
    {
        ...
        $session = \app\admin\model\ServiceSession::where('id',$ids)->find();
    ...
    public function send()
    {
        if ($this->request->isPost()) {
            ...
            if ($data) {
                $session = \app\admin\model\ServiceSession::where('id',$data['session_id'])->find();
    ...
    public function getMessageList($id,$page)
    {
        ...
        $session = \app\admin\model\ServiceSession::where('id',$id)->find();
