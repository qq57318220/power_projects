...
//            !$this->auth->merchant_id or $where[$this->mch_id] = $this->auth->merchant_id;
//        }else{
//            $where[$this->mch_id] = $merchant_id;
//        }
    ...
    public function edit($ids = null)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                $params['pid'] != $row['id'] or $this->error('父ID不能选自己');
    ...
    public function selectpage()
    {
        ...
        if ($total > 0) {
            ...
            if ($istree && $primaryvalue === null) {
                $tree = Tree::instance();
                is_array($list) or $list = collection($list)->toArray();
                $tree->init($list);
