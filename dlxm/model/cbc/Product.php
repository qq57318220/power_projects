...
class Product extends Model
{
    ...
    {
        return ['new' => __('Tags new'), 'hot' => __('Tags hot'), 'rush' => __('Tags rush'), 'guss' => __('Tags guss'), 'score' => __('Tags score')];
    }
    ...
    {
        return $this->hasMany('app\cbc\model\shop\product\Prop','product_id');
    }

    public function merchant(){
        return $this->hasOne('app\cbc\model\Merchant','id','merchant_id');
    }
}
